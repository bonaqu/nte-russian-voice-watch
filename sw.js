const CACHE_VERSION = 'nte-voice-v1.1.5';
const STATIC_CACHE = `${CACHE_VERSION}-static`;
const DATA_CACHE = `${CACHE_VERSION}-data`;
const STATIC_ASSETS = [
  './', './index.html', './appeal.html', './manifest.webmanifest',
  './assets/css/styles.css', './assets/css/appeal.css', './assets/css/i18n.css', './assets/css/ux.css', './assets/css/ux-prod.css', './assets/css/ux-final.css',
